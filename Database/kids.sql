...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2022 at 10:53 PM
...
CREATE TABLE `bill` (
  ...
  `bill_data` date NOT NULL DEFAULT current_timestamp(),
  `id` int(255) NOT NULL
...
INSERT INTO `cart` (`cart_id`, `product_id`, `quantity`, `id`, `total_cart`, `coupon`) VALUES
(1, 2, 6, 1, '0', ''),
(2, 15, 6, 1, '0', '');
...
(5, 'Flower Garden Preschool Toys', 'PLAY AND PRETEND - Create your own pretend play flower garden in an ultimate sensory play experience! Engage the senses with a unique play space bin filled with easy to mold sensory sand in 2 colors, faux flowers and critters, shovel, tongs and more!', '12', 1, 1, '../img/cat1/5.jpg'),
...
(12, 'Coplus 5 in 1 STEM Robot Building Kit\r\n', '5-in-1 RC Building Kit STEM Robot building toy can be built into 5 models: Robot /Racing Tank/Tracked Cars.This toys have a flexible rotating head & arm,interesting and novel transforming.It allows kids explore more imaginations and creativity and exercis', '50', 1, 4, '../img/cat4/2.jpg'),
...
(22, 'Book - Dreaming of Australia A-Z Stories', 'A delightful Australian alphabet that travels the country highlighting the expected and unexpected.', '20', 1, 3, '../img/cat3/2.png'),
...
(25, 'Learn & Grow Magnetic Tiles - 64 piece set', 'Featuring our new and exclusively designed large square. We had added magnets through the large square to expand building capabilities.  ', '60', 1, 3, '../img/cat3/5.png'),
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`id`) REFERENCES `register` (`id`),
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`id`) REFERENCES `register` (`id`),
  ADD CONSTRAINT `cart_ibfk_3` FOREIGN KEY (`id`) REFERENCES `register` (`id`);

--
-- Constraints for table `comment`
--
ALTER TABLE `comment`
  ADD CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`id`) REFERENCES `register` (`id`);
